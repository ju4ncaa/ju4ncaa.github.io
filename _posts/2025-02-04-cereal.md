...
Puedo crear un enlace simbólico que apunte a /etc/sudoers, esto provocará que cuando root ejecute la tarea chown.sh se asigne propietario rocky y grupo apache al archivo sudoers y ya pueda por ejemplo modificar que binarios puedo ejecutar y con que privilegios
