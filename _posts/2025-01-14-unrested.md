...
En GitHub encontramos un repositorio el cual permite automatizar la explotación de CVE-2024-42327 a través de un script de Python, podemos ejecutar o realizar la explotación de forma manual
