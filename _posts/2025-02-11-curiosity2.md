...
tags: [thl, hacking, the hacker labs, active directory, llmnr, sqlcmd, dcsync, bloodhound medium, writeup, redteam, pentesting]
image_post: true
...
Observo que el usuario MSOL puede realizar un DCSync Attack sobre el controlador de dominio, esto permite hacerse pasar por el DC y solicitar información sensible, por ejemplo los hashes de la contraseñas de los usuarios
