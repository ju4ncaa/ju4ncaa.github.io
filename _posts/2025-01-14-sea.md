...
Utilizo ffuf para realizar enumeración de directorios exhaustiva

```bash
ffuf -u "http://10.10.11.28/FUZZ" -w /usr/share/seclists/Discovery/Web-Content/directory-list-2.3-medium.txt -t 200 -fc 403 -fw 582
-------------------------------------------------------------------------------------
plugins                 [Status: 301, Size: 235, Words: 14, Lines: 8, Duration: 40ms]
messages                [Status: 301, Size: 236, Words: 14, Lines: 8, Duration: 39ms]
404                     [Status: 200, Size: 3361, Words: 530, Lines: 85, Duration: 39ms]
themes                  [Status: 301, Size: 234, Words: 14, Lines: 8, Duration: 8029ms]
data                    [Status: 301, Size: 232, Words: 14, Lines: 8, Duration: 8282ms]
```

```bash
ffuf -u "http://10.10.11.28/plugins/FUZZ" -w /usr/share/seclists/Discovery/Web-Content/directory-list-2.3-medium.txt -t 200 -fc 403
-------------------------------------------------------------------------------------
home                    [Status: 200, Size: 3670, Words: 582, Lines: 87, Duration: 41ms]
